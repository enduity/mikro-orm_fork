...
* **entity-generator:** emit enum definitions before entity class ([bbb38c7](https://github.com/mikro-orm/mikro-orm/commit/bbb38c7b8cb6a2757ffcfd444132eac77bbac1bc))
...
* update lockfile for v7 peer dependencies ([d59eaea](https://github.com/mikro-orm/mikro-orm/commit/d59eaeac650a01dddc35dea189e428c4dbb3c7f4))
...
* **core:** allow using property accessor on to-one relations ([621d10a](https://github.com/mikro-orm/mikro-orm/commit/621d10a71057bb936b2e782091bfdcdf0f239ced)), closes [#7211](https://github.com/mikro-orm/mikro-orm/issues/7211)
* **core:** always check the database when querying by PK with filters ([8bd62b2](https://github.com/mikro-orm/mikro-orm/commit/8bd62b2f9644bd16be6eedd0cc5f16e3888e3d3d)), closes [#7084](https://github.com/mikro-orm/mikro-orm/issues/7084)
* **core:** do not convert custom types in `em.refresh` ([3f8abdf](https://github.com/mikro-orm/mikro-orm/commit/3f8abdfddd420a9bc15c1e03b3ef0b23843e953d)), closes [#7073](https://github.com/mikro-orm/mikro-orm/issues/7073)
* **core:** do not propagate cursor related options to populate queries ([e667290](https://github.com/mikro-orm/mikro-orm/commit/e667290e7a89e9bf848095b21ef80b423f532a44)), closes [#7148](https://github.com/mikro-orm/mikro-orm/issues/7148)
* **core:** duplicate discovery of embeddables with defineEntity ([#7125](https://github.com/mikro-orm/mikro-orm/issues/7125)) ([3d57516](https://github.com/mikro-orm/mikro-orm/commit/3d57516348d75ba420cf2b0b6eee8fa81ae9447d))
* **core:** enable `forceUtcTimezone` by default for all SQL drivers ([#7087](https://github.com/mikro-orm/mikro-orm/issues/7087)) ([c89890b](https://github.com/mikro-orm/mikro-orm/commit/c89890b72ee2cfeaeaf581b64a1360d33bfe93ce)), closes [#5591](https://github.com/mikro-orm/mikro-orm/issues/5591)
* **core:** ensure `populate` hint won't include `undefined` for optional relations ([ea6722c](https://github.com/mikro-orm/mikro-orm/commit/ea6722cfa95eaf72a6783069c9ee07c8c38737b5))
* **core:** ensure column name conflicts in M:N are propagated to STI child entities ([562515c](https://github.com/mikro-orm/mikro-orm/commit/562515c7b2141430cef4b0bb8f7a9517a2162594)), closes [#7123](https://github.com/mikro-orm/mikro-orm/issues/7123)
* **core:** ensure no collisions in polymorphic embeddables with shadowed properties ([25554b1](https://github.com/mikro-orm/mikro-orm/commit/25554b19f944a58794c6219678998658e05c7d15))
* **core:** ensure owning FK is selected for to-many inverse sides ([cead90d](https://github.com/mikro-orm/mikro-orm/commit/cead90d70eb797d36bf455014618f46722a1d264))
* **core:** fix applying filters on nested relation conditions ([e828240](https://github.com/mikro-orm/mikro-orm/commit/e82824089614e8c269fd6140345a3e5f9a9015b2))
* **core:** fix double processing of JSON properties when reloading an entity ([945e5cd](https://github.com/mikro-orm/mikro-orm/commit/945e5cdc3411d7e5e7924373a8f7f9bd07b58f06))
* **core:** fix enum arrays with `defineEntity` failing on metadata validation ([0412fd3](https://github.com/mikro-orm/mikro-orm/commit/0412fd32c5ee20511b4aecff5773abdfafda4bf4))
...
* **core:** fix processing filters on to-many relations ([8b193aa](https://github.com/mikro-orm/mikro-orm/commit/8b193aaff6d9f71ccc93b82b59f26e0d1f23ef2c))
* **core:** fix result caching for custom types ([10a4044](https://github.com/mikro-orm/mikro-orm/commit/10a4044c2692a90533a41e45942c7a0e7676bdbf)), closes [#7112](https://github.com/mikro-orm/mikro-orm/issues/7112)
* **core:** improve handling of deeply nested composite keys in `em.create` ([28261a0](https://github.com/mikro-orm/mikro-orm/commit/28261a07197678ebff720741211af547dbab0dbe)), closes [#6894](https://github.com/mikro-orm/mikro-orm/issues/6894)
* **core:** improve intellisense for partial loading in `em.populate` ([384f432](https://github.com/mikro-orm/mikro-orm/commit/384f432324d9434fdf7e841aea89ce8e7877c0c2))
* **core:** make entity prototype `toJSON` non-enumerable to prevent data leaks ([013f57f](https://github.com/mikro-orm/mikro-orm/commit/013f57f3662333ffc24582ce069dcbc1ddc775cd))
* **core:** map arrays inside object embeddables to JSON arrays by default ([6835f72](https://github.com/mikro-orm/mikro-orm/commit/6835f72453f20e66d31b08f1ba6c6dd200a35885))
* **core:** normalize `populate` option in `Collection.matching()` for M:N relations ([#7091](https://github.com/mikro-orm/mikro-orm/issues/7091)) ([d9b996f](https://github.com/mikro-orm/mikro-orm/commit/d9b996fff09010c88e54b6e6748e2d98eae9f113))
* **core:** only respect `Hidden` type on scalar properties ([#7097](https://github.com/mikro-orm/mikro-orm/issues/7097)) ([36372a2](https://github.com/mikro-orm/mikro-orm/commit/36372a2a7e2320db3ecd0b43854efcbf71876ce3)), closes [#7062](https://github.com/mikro-orm/mikro-orm/issues/7062)
* **core:** preserve embeddable properties in `toPOJO` regardless of partial loading hints ([455be24](https://github.com/mikro-orm/mikro-orm/commit/455be2437b08c557dbcbdc7151736548ccdab721))
* **core:** preserve function expression indexes through metadata cache round-trip ([#7228](https://github.com/mikro-orm/mikro-orm/issues/7228)) ([b7c002c](https://github.com/mikro-orm/mikro-orm/commit/b7c002ced299f893b88be188854a58961bf584b2))
* **core:** prevent double JSON-encoding of nested embeddable arrays ([ba22eba](https://github.com/mikro-orm/mikro-orm/commit/ba22eba80ae5dc447ac518e40ede890faf2fd5e2))
* **core:** prevent property mutation during polymorphic embeddable discovery ([#7270](https://github.com/mikro-orm/mikro-orm/issues/7270)) ([c3a5978](https://github.com/mikro-orm/mikro-orm/commit/c3a5978a6c04771295de473c4ee83379e12654fc)), closes [#6522](https://github.com/mikro-orm/mikro-orm/issues/6522)
...
* **core:** respect `exclude` option on eager properties ([908e236](https://github.com/mikro-orm/mikro-orm/commit/908e236e10e0bb71f473d986bc995e86a255e506))
* **core:** respect `orphanRemoval` on 1:1 relations when inverse side is a PK ([#7081](https://github.com/mikro-orm/mikro-orm/issues/7081)) ([960425c](https://github.com/mikro-orm/mikro-orm/commit/960425c6035ad1f6f192abe64ae6e0a764def80c))
* **core:** respect custom repositories with `InferEntity` ([c5160ee](https://github.com/mikro-orm/mikro-orm/commit/c5160ee163a8db6e0170c08a2acc66b4c63fc71d))
* **core:** respect EM schema when joining a wildcard entity from a static schema entity ([69ca26c](https://github.com/mikro-orm/mikro-orm/commit/69ca26c107b34d812d70568d0d9b3bec446d7cc2)), closes [#7082](https://github.com/mikro-orm/mikro-orm/issues/7082)
* **core:** respect explicit `tableName` when computing join table names ([fe5e10f](https://github.com/mikro-orm/mikro-orm/commit/fe5e10f49db273a5601f0de9c087ddb5f9da7bff))
* **core:** respect loaded hint for `Ref` relations inside array embeddables ([27efe05](https://github.com/mikro-orm/mikro-orm/commit/27efe05cfd5dc857e641807eaa8d07022b73947c))
* **core:** support overlapping properties with different field names in STI ([5d83d0f](https://github.com/mikro-orm/mikro-orm/commit/5d83d0f1649c8cb735ead5eda5297758670baa23)), closes [#5813](https://github.com/mikro-orm/mikro-orm/issues/5813)
* **core:** support querying by all keys of discriminated union types ([21b7a80](https://github.com/mikro-orm/mikro-orm/commit/21b7a807b5d5b101314ecc6bc2c70aabad2ef5d6)), closes [#7111](https://github.com/mikro-orm/mikro-orm/issues/7111)
* **core:** support schema parameter in formula query when using QB with partial loading ([4820bb6](https://github.com/mikro-orm/mikro-orm/commit/4820bb6e7cbae0ba1d471d86f487153dfd309575))
* **core:** support wildcard `wrap(e).populate()` hints on type level ([a05e46c](https://github.com/mikro-orm/mikro-orm/commit/a05e46caea540aedf95a33bc298fa687b1de7052))
* **core:** use full hydration in `mergeData` for initialized entities ([32a0baa](https://github.com/mikro-orm/mikro-orm/commit/32a0baa112bccb71dc65af390bb3eddbbee1321c)), closes [#7205](https://github.com/mikro-orm/mikro-orm/issues/7205)
* **core:** use less strict `repository` option type to fix issues with `defineEntity` and cycles ([7110dc3](https://github.com/mikro-orm/mikro-orm/commit/7110dc39472ae7faf155722367fd25379f75e116))
* **defineEntity:** fix inference issues in `hooks` definition ([d5e9f92](https://github.com/mikro-orm/mikro-orm/commit/d5e9f92e96d306e24f5240fd82e59f1207d0b21b))
...
* guard prototype.toJSON against being called on prototype itself ([#7152](https://github.com/mikro-orm/mikro-orm/issues/7152)) ([0392156](https://github.com/mikro-orm/mikro-orm/commit/0392156581c8cf4a696cf2626241089c5dca0f4d)), closes [#7151](https://github.com/mikro-orm/mikro-orm/issues/7151)
...
* **postres:** fix casting of object embedded relation properties ([0e80f59](https://github.com/mikro-orm/mikro-orm/commit/0e80f5977803d1f5f44475f8e8114fd6973e392a))
...
* **sti:** ensure stable order in the generated discriminator map ([b51d6fd](https://github.com/mikro-orm/mikro-orm/commit/b51d6fd7379050f45a2b6d09400ddaf9788d94e5)), closes [#6455](https://github.com/mikro-orm/mikro-orm/issues/6455)
...
* change default `loadStrategy` to `balanced` ([431f989](https://github.com/mikro-orm/mikro-orm/commit/431f989ac3a10d5e58f1dbb53a0b716a5e11a244))
* **cli:** support various TS loaders ([#6987](https://github.com/mikro-orm/mikro-orm/issues/6987)) ([3fe125c](https://github.com/mikro-orm/mikro-orm/commit/3fe125ca43b72d609bbaa1450e47027c0e02e9da))
* **core:** add `$size` collection operator ([#7090](https://github.com/mikro-orm/mikro-orm/issues/7090)) ([e12051e](https://github.com/mikro-orm/mikro-orm/commit/e12051e45e50cc67f44ee3ea4ba8b54899c580e8))
* **core:** add `collation` support and MongoDB query options ([#7189](https://github.com/mikro-orm/mikro-orm/issues/7189)) ([e350aa1](https://github.com/mikro-orm/mikro-orm/commit/e350aa12a7fb67fd83f57bad2b84290c539750ea))
* **core:** add `EntityName` symbol for decorator-based Kysely type inference ([#7199](https://github.com/mikro-orm/mikro-orm/issues/7199)) ([0b78e36](https://github.com/mikro-orm/mikro-orm/commit/0b78e36cf0feb3581446b85abdc0e8d2e62ae373))
* **core:** add `EntitySchema.new` helper to create entity instances ([#7077](https://github.com/mikro-orm/mikro-orm/issues/7077)) ([64ad492](https://github.com/mikro-orm/mikro-orm/commit/64ad49293ce985972b895cf4c6ee4310cb2d9110))
* **core:** add `forceObject` option to `defineEntity` ([0a3df4d](https://github.com/mikro-orm/mikro-orm/commit/0a3df4d429b11384a0a246cb0bb89f43117d7c84))
* **core:** add `populateHints` option to `FindOptions` for per-relation populate overrides ([#7198](https://github.com/mikro-orm/mikro-orm/issues/7198)) ([158e1cf](https://github.com/mikro-orm/mikro-orm/commit/158e1cf43cd4e1aa697d52c673717d61b94561cd))
* **core:** add entity-level default `orderBy` option ([#7133](https://github.com/mikro-orm/mikro-orm/issues/7133)) ([4bfa0e4](https://github.com/mikro-orm/mikro-orm/commit/4bfa0e43d24da36eb8fe0164428e47e2c94f0198))
* **core:** add slow query logging support ([#7271](https://github.com/mikro-orm/mikro-orm/issues/7271)) ([13b97f5](https://github.com/mikro-orm/mikro-orm/commit/13b97f5e0b79e21084a3c57bcd1efab2d0c5c260)), closes [#4695](https://github.com/mikro-orm/mikro-orm/issues/4695)
* **core:** add support for polymorphic relations ([#7121](https://github.com/mikro-orm/mikro-orm/issues/7121)) ([e9eb256](https://github.com/mikro-orm/mikro-orm/commit/e9eb256c9cd021f51c8db4e53655cfd2e7834fce))
* **core:** add support for streaming ([#6923](https://github.com/mikro-orm/mikro-orm/issues/6923)) ([88b0d5b](https://github.com/mikro-orm/mikro-orm/commit/88b0d5bbe8de8c1f7afb70b2162af124e8683440))
* **core:** add support for Table-Per-Type inheritance ([#7137](https://github.com/mikro-orm/mikro-orm/issues/7137)) ([f6abee5](https://github.com/mikro-orm/mikro-orm/commit/f6abee5c8e6a0a5a40d5c200f28eaa1710b92b26))
* **core:** add support for view entities ([#7116](https://github.com/mikro-orm/mikro-orm/issues/7116)) ([7bfcb10](https://github.com/mikro-orm/mikro-orm/commit/7bfcb10cee8e2bbe2a3d1b82c96ebb2bc77fd267))
* **core:** add WHERE clause support to upsert via `onConflictWhere` option ([#7117](https://github.com/mikro-orm/mikro-orm/issues/7117)) ([673c1bb](https://github.com/mikro-orm/mikro-orm/commit/673c1bb1c4250a67d65b301852af4b2d7c8195b1))
* **core:** allow reusing raw query fragments ([#7058](https://github.com/mikro-orm/mikro-orm/issues/7058)) ([bcf8cb7](https://github.com/mikro-orm/mikro-orm/commit/bcf8cb7fcb498cfdff8370111970f827ee7779af))
* **core:** execute transaction events on child transactions ([0fc822f](https://github.com/mikro-orm/mikro-orm/commit/0fc822f586cba0672fce846ddab19eb87b76290a))
* **core:** improve formula callback to provide more information about the table and column mapping ([#7105](https://github.com/mikro-orm/mikro-orm/issues/7105)) ([9ee78d5](https://github.com/mikro-orm/mikro-orm/commit/9ee78d5940b57dd2f5e4fa7ff4dda3af62d3cd27))
* **core:** improve type safety of various decorators ([463eef6](https://github.com/mikro-orm/mikro-orm/commit/463eef69c0aef21af9cf4cf8e19fbc4ea374a710))
* **core:** make `em.assign` typing stricter to catch typos ([5c3aea1](https://github.com/mikro-orm/mikro-orm/commit/5c3aea1316eb6a465f7c30913727174f82c32a36))
* **core:** make `em.create` typing stricter to catch typos ([39e8c30](https://github.com/mikro-orm/mikro-orm/commit/39e8c30754f714d1e040639bb58193e533496c61))
* **core:** move file discovery to separate file ([#6993](https://github.com/mikro-orm/mikro-orm/issues/6993)) ([d880412](https://github.com/mikro-orm/mikro-orm/commit/d8804123f72cc99f2222e4b7217caf56619f5e0f))
* **core:** propagate persist stack in `em.transactional` fork ([0c90e67](https://github.com/mikro-orm/mikro-orm/commit/0c90e67e83de26e16c20bbd01ef8a20abfbb3a92))
* **core:** support FKs pointing to non-PK columns via `targetKey` option ([#7099](https://github.com/mikro-orm/mikro-orm/issues/7099)) ([f98541b](https://github.com/mikro-orm/mikro-orm/commit/f98541b1a0c32a6389a953c91e3f287be027bcf5))
* **core:** support null values in cursor-based pagination ([#7095](https://github.com/mikro-orm/mikro-orm/issues/7095)) ([b1fb67c](https://github.com/mikro-orm/mikro-orm/commit/b1fb67c819b8c150fc7be07736e6d44354bd8e8f))
* **core:** support pre-compiled functions for eval-free runtimes ([#7166](https://github.com/mikro-orm/mikro-orm/issues/7166)) ([d8b2c3e](https://github.com/mikro-orm/mikro-orm/commit/d8b2c3e41abe605c3cf9cb17f3eddebe631c5c27))
* **core:** validate dangerous property names ([#7089](https://github.com/mikro-orm/mikro-orm/issues/7089)) ([78e570d](https://github.com/mikro-orm/mikro-orm/commit/78e570dcf2fdbfd907f8ce41f9e7125d040564a8))
* **decorators:** introduce `@mikro-orm/decorators` package with legacy and ES decorator definitions ([#7011](https://github.com/mikro-orm/mikro-orm/issues/7011)) ([81e5e97](https://github.com/mikro-orm/mikro-orm/commit/81e5e9741bf7e322e24806f1f4bf188bac62eb70))
* **defineEntity:** allow extending generated class with custom methods ([#7104](https://github.com/mikro-orm/mikro-orm/issues/7104)) ([25362b8](https://github.com/mikro-orm/mikro-orm/commit/25362b840025ce1f077006cb8bb54c7d87baf8d4))
...
* **seeder:** remove `tinyglobby` dependency, add `seedersList` option ([#7206](https://github.com/mikro-orm/mikro-orm/issues/7206)) ([7f923e5](https://github.com/mikro-orm/mikro-orm/commit/7f923e536ceed6d3772d3d3610d6d17d25ffb900))
...
* **sqlite:** add `ATTACH DATABASE` support for multiple database files ([#7131](https://github.com/mikro-orm/mikro-orm/issues/7131)) ([27f9cac](https://github.com/mikro-orm/mikro-orm/commit/27f9cacd4bff486004f6ca405abc0399a43af8d0))
* **sqlite:** enable down migrations ([bd3bb56](https://github.com/mikro-orm/mikro-orm/commit/bd3bb56d8b48b3513cce986f7a65ae4fa654df3a))
* **sqlite:** simplify using other sqlite libraries like `node:sqlite` ([#7204](https://github.com/mikro-orm/mikro-orm/issues/7204)) ([7e8da43](https://github.com/mikro-orm/mikro-orm/commit/7e8da4340858e23e49549fdd884351c193e1c0e1))


### Performance Improvements

* **core:** improve `defineEntity` type performance ([#7202](https://github.com/mikro-orm/mikro-orm/issues/7202)) ([d7491a7](https://github.com/mikro-orm/mikro-orm/commit/d7491a72c5e04f36cfd7f0e58d9c9179690bac4e))
* **core:** improve `InferEntity` performance when `extends` is used ([#7120](https://github.com/mikro-orm/mikro-orm/issues/7120)) ([f6640e8](https://github.com/mikro-orm/mikro-orm/commit/f6640e8f9aadba91b88af52bae0cce5b2f4f41f9))
* **core:** improve `Loaded` type performance by optimizing field selection ([#7201](https://github.com/mikro-orm/mikro-orm/issues/7201)) ([a34269a](https://github.com/mikro-orm/mikro-orm/commit/a34269ab76ed168db1ab643cc5c200317a0d1754))
* **core:** improve inference via `InferEntity` type ([#7108](https://github.com/mikro-orm/mikro-orm/issues/7108)) ([9f8f393](https://github.com/mikro-orm/mikro-orm/commit/9f8f39345e1de9c34be2578870aeb12f1b44ea4d))
* **core:** optimize `AutoPath` and `Loaded` type instantiation costs ([#7128](https://github.com/mikro-orm/mikro-orm/issues/7128)) ([6f7349d](https://github.com/mikro-orm/mikro-orm/commit/6f7349d4ad6ee413a729d7dca0dcdc0b86ae09d3))
* **core:** optimize `em.assign` typing ([#7129](https://github.com/mikro-orm/mikro-orm/issues/7129)) ([9e84be3](https://github.com/mikro-orm/mikro-orm/commit/9e84be341a37ad307e45837a8283405a75f21dcf))
* **core:** optimize type instantiation costs with structural shapes ([#7132](https://github.com/mikro-orm/mikro-orm/issues/7132)) ([b6b0f0f](https://github.com/mikro-orm/mikro-orm/commit/b6b0f0f928cf54d172a17a5488a700058f841d66))
* **core:** rework auto-flush detection to rely on explicit `em.persist` calls ([#6982](https://github.com/mikro-orm/mikro-orm/issues/6982)) ([e66f138](https://github.com/mikro-orm/mikro-orm/commit/e66f13813f97da247893f1a3fc3ac95ab55288d9))
...
* **core:** fix findOne with entity refs for composite PKs with shared FK columns ([6f95f72](https://github.com/mikro-orm/mikro-orm/commit/6f95f7255aa1b620372cff036e29cc39df078ca0)), closes [#5629](https://github.com/mikro-orm/mikro-orm/issues/5629)
* **core:** make entity prototype `toJSON` non-enumerable to prevent data leaks ([c895808](https://github.com/mikro-orm/mikro-orm/commit/c89580864e94c64a6e68b81f9900e0a6f2d57760))
* **core:** prevent double JSON-encoding of nested embeddable arrays ([309b278](https://github.com/mikro-orm/mikro-orm/commit/309b27853d69a3ecc3d4722842b6fc40381b886d)), closes [#7233](https://github.com/mikro-orm/mikro-orm/issues/7233)
